...
-- theme_path = "/home/odetour/conf/awesome/themes/chino"
...
globalkeys =
{
    ...
    -- Layout manipulation
    key({ modkey, 	    }, "Up",	function () awful.client.swap.byidx(  1) end),
    key({ modkey, 	    }, "Down",	function () awful.client.swap.byidx( -1) end),
    ...
    key({ modkey,           }, "Right", function () awful.tag.incmwfact( 0.05)    end),
    key({ modkey,           }, "Left",  function () awful.tag.incmwfact(-0.05)    end),
